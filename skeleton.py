...
master_price1 = AccountValue(2, "2020/12/04", 1000000, master.id)
master_price1.insertIntoDB(con)
master_price2 = AccountValue(1, "2021/02/06", 1500000, master.id)
master_price2.insertIntoDB(con)
BofA_price3 = AccountValue(3, "2020/12/04", 525000, BofA.id)
